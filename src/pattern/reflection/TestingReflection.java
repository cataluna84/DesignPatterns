...
import pattern.abstractFactory.EnemyShipFactory;
...
public class TestingReflection {
	...
	public static void main(String[] args) {
		...
		System.out.println("Is String.class final? "
				+ Modifier.isFinal(String.class.getModifiers()));

		// You can get a list of interfaces used by a class
		Class[] interfaces = Boolean.class.getInterfaces();
		System.out.println("\n\nList of interfaces used by Boolean.class : ");
		for (Class objInterface : interfaces) {
			System.out.println(objInterface);
		}

		// Get the super class for UFOEnemyShip
		Class classSuper = reflectClass.getSuperclass();
		System.out.println("The super class for UFOEnemyShip is- "
				+ classSuper.getName() + "\n");
		...
		try {
			// If you know the parameters of the constructor you want you do the
			// following.
		...
		try {
			...
			System.out.println("EnemyShip Private Field Name: " + valueOfName);
