...
public final class ImmutableClass {
	 ...
	 * @param hm
	 */
	public ImmutableClass(int i, String n, HashMap<String, String> hm, A a) throws CloneNotSupportedException {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		System.out.println("A created in main(): " + a);
		ImmutableClass ce = new ImmutableClass(i, s, h1, a);
		...
		System.out.println("ce A:" + ce.getA());
		...
		System.out.println("ce testMap after local variable change:"
				+ ce.getTestMap());
		System.out.println("ce A after local variable change:"
				+ ce.getA());
