...
public class MatchMakingTestDrive {
	...
	PersonBean getOwnerProxy(PersonBean person) {
		...
		try {
			InvocationHandler handler = new OwnerInvocationHandler(person);
			Class proxyClass = Proxy.getProxyClass(
					PersonBean.class.getClassLoader(),
					new Class[] { PersonBean.class });
			personBean = (PersonBean) proxyClass.getConstructor(
		 ...
		 * .getClassLoader(), person.getClass().getInterfaces(), new
